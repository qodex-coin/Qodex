...
RESOURCES += src/qt/qodex.qrc src/qt/qodex_locale.qrc

TRANSLATIONS += src/qt/locale/qodex_bg.ts \
                src/qt/locale/qodex_de.ts \
                src/qt/locale/qodex_en.ts \
                src/qt/locale/qodex_es.ts \
                src/qt/locale/qodex_fi.ts \
                src/qt/locale/qodex_fr.ts \
                src/qt/locale/qodex_it.ts \
                src/qt/locale/qodex_ja.ts \
                src/qt/locale/qodex_pl.ts \
                src/qt/locale/qodex_pt.ts \
                src/qt/locale/qodex_ru.ts \
                src/qt/locale/qodex_sk.ts \
                src/qt/locale/qodex_sv.ts \
                src/qt/locale/qodex_vi.ts \
                src/qt/locale/qodex_zh_CN.ts \
                src/qt/locale/qodex_zh_TW.ts

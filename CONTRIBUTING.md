Contributing to Qodex Core
============================

The Qodex Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/forking-altcoins/qodex/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Qodex Core project, and is not to be
confused with overall Qodex Network Protocol consensus changes.

Whether a pull request is merged into Qodex Core rests with the project merge
...
Patches that change Qodex consensus rules are considerably more involved than
...
Where a patchset proposes to change the Qodex consensus, it must have been
...
The project leader is the release manager for each Qodex Core release.

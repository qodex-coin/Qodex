...
// Copyright (c) 2016-2019 The Qodex developers
...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 QDEX
    ...
    MAKE_SPORK_DEF(SPORK_17_COLDSTAKING_ENFORCEMENT,        750),           // active since the block 750
...
// Qodex: on startup load spork values from previous session if they exist in the sporkDB

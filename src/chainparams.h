 ...
 * Qodex system. There are three: the main network on which people trade goods
...
public:
    ...
    int QodexBadBlockTime() const { return nQodexBadBlockTime; }
    int QodexBadBlocknBits() const { return nQodexBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nQodexBadBlockTime;
    unsigned int nQodexBadBlocknBits;

/* src/config/qodex-config.h.  Generated from qodex-config.h.in by configure.  */
/* src/config/qodex-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef QDEX_CONFIG_H

#define QDEX_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/forking-altcoins/qodex/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Qodex Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Qodex Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "qodex"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://qodex.org/"

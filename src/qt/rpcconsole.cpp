                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzQDEXPathCustom = GetArg("-zQDEXbackuppath", "");
    ...
    if(!strzQDEXPathCustom.empty()) {
        ui->wallet_customzQDEXbackuppath->setText(QString::fromStdString(strzQDEXPathCustom));
        ui->wallet_customzQDEXbackuppath_label->setVisible(true);
        ui->wallet_customzQDEXbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzQDEXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Qodex RPC console.") + "<br>" +

// Copyright (c) 2017-2020 The Qodex developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "zQDEXcontroldialog.h"
#include "ui_zQDEXcontroldialog.h"
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zQDEX Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zQDEX.";
            else if (!mint.isSeedCorrect)
                strReason = "The zQDEX seed used to mint this zQDEX is not the same as currently hold in the wallet";
            else

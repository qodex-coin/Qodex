...
/** Utility functions used by the Qodex Qt UI.
 */
namespace GUIUtil
{
...
// Render Qodex addresses in monospace font
...
// Parse "qodex:" URI into recipient object, return true on successful parsing

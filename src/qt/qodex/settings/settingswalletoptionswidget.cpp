...
#include "qt/qodex/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/qodex/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(QodexGUI* _window, QWidget *parent) :

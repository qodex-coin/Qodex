...
#include "qt/qodex/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/qodex/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(QodexGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to QodexGUI::handleRestart()

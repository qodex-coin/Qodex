...
#include "qt/qodex/forms/ui_addresseswidget.h"
#include "qt/qodex/addresslabelrow.h"
#include "qt/qodex/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(QodexGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter Qodex address"));

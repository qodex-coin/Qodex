...
#include "qt/qodex/coldstakingwidget.h"
#include "qt/qodex/forms/ui_coldstakingwidget.h"
#include "qt/qodex/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/qodex/requestdialog.h"
#include "qt/qodex/tooltipmenu.h"
#include "qt/qodex/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(QodexGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your QDEXs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept QDEX delegation / Delegate QDEX"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select QDEX outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 QDEX" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}

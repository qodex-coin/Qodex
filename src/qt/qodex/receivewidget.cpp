...
#include "qt/qodex/forms/ui_receivewidget.h"
...
#include "qt/qodex/addressholder.h"
...
ReceiveWidget::ReceiveWidget(QodexGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive QDEX."));

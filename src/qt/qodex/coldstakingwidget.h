...
#include "qt/qodex/furabstractlistitemdelegate.h"
#include "qt/qodex/txviewholder.h"
#include "qt/qodex/tooltipmenu.h"
#include "qt/qodex/sendmultirow.h"
#include "qt/qodex/coldstakingmodel.h"
#include "qt/qodex/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(QodexGUI* parent);
    ~ColdStakingWidget();

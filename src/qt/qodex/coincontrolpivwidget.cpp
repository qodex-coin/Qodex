...
#include "qt/qodex/coincontrolpivwidget.h"
#include "qt/qodex/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select QDEX Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("QDEX");
    ...
    ui->labelValueAfter->setText("0.00 QDEX");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 QDEX");
    ui->labelValueFee->setText("0.00 QDEX");

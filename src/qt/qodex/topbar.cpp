...
#include "qt/qodex/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/qodex/lockunlock.h"
#include "qt/qodex/qtutils.h"
#include "qt/qodex/receivedialog.h"
...
TopBar::TopBar(QodexGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("Qodex")
    updateDisplayUnit();

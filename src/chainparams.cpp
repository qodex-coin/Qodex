...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000efa3ea8b70f4b01d28c98484bc89cd31b8aa9bd9bd5e5f596e066bf6490"));  //launch
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1675772708, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0427530ab71dade288d053fb759da19ae7f3abb207ea9046cd24ad47ea93e4e9d8799cd33861e3e37ed38b77f4f9a316e2bee595ed4478a7b58fe5b4f4c674f273");
        nDefaultPort = 15348;
        ...
        nEnforceNewSporkKey = 1675772708; //!> Sporks signed after Monday, August 26, 2019 11:00:00 PM GMT must use the new spork key
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Tuesday, February 7, 2023 18:25:08 GMT+06:00 - start blockchain QDEX.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0448d1fdc18be6354ef83862f3ac489d618d12d8f7489685686e248c48ee2a5fbf7772a4791d05227fb7f746844bc5f425d77362be6fc9e3afc4d9c6893b1c1015") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1675772708;
        genesis.nBits = 0x1e0fffff;
        genesis.nNonce = 3973641;
	
	
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000efa3ea8b70f4b01d28c98484bc89cd31b8aa9bd9bd5e5f596e066bf6490"));
        assert(genesis.hashMerkleRoot == uint256("0xaab4c1e111afe87ac97f4809b47478516ee74149be85ec249e4c6e72eaf6f9a6"));

		vFixedSeeds.clear();
		vSeeds.clear();

        vSeeds.push_back(CDNSSeedData("65.108.56.165", "65.108.56.165"));
        vSeeds.push_back(CDNSSeedData("78.47.232.46", "78.47.232.46"));
        ...
        strSporkPubKey = "042eddea2413bbd687ebdde535bb401a857d224ee74b7c988369602cb639f938c222aa7d6c129ff005764ce42ffcf81cbec71a3815af4cf5e3a6c136a655d75e6e";
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("048d359ffd47fc399263db8433c31aca6c19c47965b4eb56db4a0afb24c645813f1b2322065ac443af074e1870d404f2a3fdd4322c524bc2719ba51f7b9bf5c97d");
        nDefaultPort = 19340;
        ...
        strSporkPubKey = "04635790bebe1d067fb797f351d98a03ee7d26fbd89e442b3cfc5ea1b155f941d087b5b9440d675ae13f3f7220ed157839456fdf7da1509ec4d15db33192bb293c";
        ...
        strObfuscationPoolDummyAddress = "LW5mnPduovqtohyQXYmcVwA7LH2TRSaCh5";
        nStartMasternodePayments = 1675772708; //Fri, 09 Jan 2015 21:05:58 GMT

// Copyright (c) 2017-2018 The Qodex developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Qodex_ZQDEXWALLET_H
#define Qodex_ZQDEXWALLET_H
...
public:
    CzQDEXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZQDEX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZQDEX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

...
extern UniValue setzQDEXseed(const UniValue& params, bool fHelp);
extern UniValue getzQDEXseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzQDEX(const UniValue& params, bool fHelp);
extern UniValue dzQDEXstate(const UniValue& params, bool fHelp);

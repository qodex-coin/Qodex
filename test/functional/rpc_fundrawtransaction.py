...
class RawTransactionsTest(QodexTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid qodex address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid qodex address" in e.error['message'])
